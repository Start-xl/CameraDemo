...
/// 2、The number of urb transmitted, the range is 5 - 256, and the default is 64. when high pixel and high frame rate can be appropriately increased.;
/// when multiple cameras are used together, the value can be appropriately reduced.\n
/// 3、The size of each urb transmitted, the range is 8 - 512, the default is 64, the unit is KByte.
